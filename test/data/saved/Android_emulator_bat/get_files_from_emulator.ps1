...
# $allFiles must be set like $sourceBase !
$sourceBase = '/storage/emulated/0/Documents/test/audiolearn/saved'
...
$allFiles = & adb shell "find /storage/emulated/0/Documents/test/audiolearn/saved -type f" 2>$null
