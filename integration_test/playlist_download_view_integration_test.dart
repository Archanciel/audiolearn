...
// 'https://youtube.com/playlist?list=PLzwWSJNcZTMRB9ILve6fEIS_OHGrV5R2o';
  ...
  group('Delete unique audio test', () {
    group('Using SF parms, in playlist download view, delete unique audio test',
        () {
      testWidgets(
        ...
        expect(
          loadedPlaylist.playableAudioLst.contains(commentedAudioTitleToDelete),
          false,
        );
      ...
      testWidgets(
        ...
        expect(
          loadedPlaylist.playableAudioLst
              .contains(uncommentedAudioTitleToDelete),
          false,
        );
